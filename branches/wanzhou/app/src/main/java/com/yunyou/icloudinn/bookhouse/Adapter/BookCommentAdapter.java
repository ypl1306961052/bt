...
public class BookCommentAdapter extends RecyclerView.Adapter<BookCommentAdapter.MyViewHolder> {
    private List<BookDetailData.DataBean.CommentBean> commentBean ;
    private Activity context;
    private CommentCallBack myCommentCallBack;
    private CustomProgress customProgress;
    private ArrayList<IsFever> FeverList;

    public BookCommentAdapter(List<BookDetailData.DataBean.CommentBean> commentBean, Activity context, CustomProgress customProgress, CommentCallBack commentCallBack) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.mCommendList.setAdapter(new CommonAdapter<BookDetailData.DataBean.CommentBean.ReplyBean>(context,R.layout.list_item_reply_comment,commentBean.get(position).getReply()) {
            @Override
            protected void convert(ViewHolder holder, BookDetailData.DataBean.CommentBean.ReplyBean replyBean, int position) {
