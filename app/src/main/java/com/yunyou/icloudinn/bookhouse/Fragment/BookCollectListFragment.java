...
public class BookCollectListFragment extends Fragment implements BookCollectAdapter.IonSlidingViewClickListener {//书籍的收藏
    ...
    private BookCollectData bookCollectData;
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        try {
                            ...
                            if (json.getInteger("code") == 100) {
                                bookCollectData=JSON.parseObject(response,BookCollectData.class);
                                if (bookCollectData.getData().getData().size()==0){
                                    mEmpty.setVisibility(View.VISIBLE);
                                }else {
                                    mListData.addAll(bookCollectData.getData().getData());
    ...
    public void onItemClick(View view, int position) {
        ...
        int book_id=mListData.get(position).getSource_id();
