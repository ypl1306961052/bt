...
public abstract class BaseRecyclerAdapter<T> extends RecyclerView.Adapter<BaseRecyclerViewHolder> {
    ...
    public void onBindViewHolder(BaseRecyclerViewHolder holder, int position) {
        ...
        setViewHolderData(holder,list.get(position),position ,getItemViewType(position));
    }
    ...
    * */
    public abstract void setViewHolderData(BaseRecyclerViewHolder holder, T data , int position ,int type);
}
