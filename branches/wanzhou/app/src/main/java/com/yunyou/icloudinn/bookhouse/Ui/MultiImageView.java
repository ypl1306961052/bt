...
import com.yunyou.icloudinn.bookhouse.Util.DensityUtil;
...
public class MultiImageView extends LinearLayout {
	...
	public static int MAX_WIDTH = 0;//最大宽度
	...
	private LayoutParams onePicPara;//布局的参数
	...
	private ImageView createImageView(int position) {
		...
		imageView.setBackgroundColor(getResources().getColor(R.color.grey1));
		Glide.with(getContext()).load(Api.BASE_URL+photoInfo).diskCacheStrategy(DiskCacheStrategy.ALL).into(imageView);
		return imageView;
	}
