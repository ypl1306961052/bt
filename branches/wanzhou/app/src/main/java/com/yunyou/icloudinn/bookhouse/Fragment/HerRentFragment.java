    ...
    private void initMyview(View view) {
        ...
        mCommonAdapter=new CommonAdapter<DonateBookData.DataBeanX.DataBean>(getActivity(),R.layout.list_item_rent_book,mListData) {
            ...
            protected void convert(ViewHolder holder, final DonateBookData.DataBeanX.DataBean dataBean, int position) {
                ...
                if (MyApplication.getInstance().getUser().getData().getNickname()!=null&&!(MyApplication.getInstance().getUser().getData().getNickname().isEmpty())){
                    holder.setText(R.id.item_rent_can_borrow,"正在被"+MyApplication.getInstance().getUser().getData().getNickname()+"租阅");
                }else {
